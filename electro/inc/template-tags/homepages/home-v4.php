    ...
    function electro_home_v4_products_carousel_tabs() {
        ...
        if ( is_woocommerce_activated() ) {
            ...
            $args = apply_filters( 'electro_home_v4_products_carousel_tabs_args', array(
                ...
                'columns'       => isset( $home_v4['pct']['product_columns'] ) ? $home_v4['pct']['product_columns'] : 7,
                'carousel_args' => array(
                    ...
                    'responsive'    => array(
                        ...
                        '992'   => array( 'items'   => 5 ),
                        '1200'  => array( 'items'   => 6 ),
                        '1480'  => array( 'items'   => isset( $home_v4['pct']['product_columns'] ) ? intval( $home_v4['pct']['product_columns'] ) : 7 )
                    )
                )
            ) );
