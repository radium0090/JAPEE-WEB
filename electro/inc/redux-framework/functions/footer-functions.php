...
if ( ! function_exists( 'redux_apply_footer_bottom_widgets_column_spacing' ) ) {
	function redux_apply_footer_bottom_widgets_column_spacing() {
		...
		if ( ! empty( $electro_options['footer_bottom_widgets_column_spacing'] ) && '5.357em' != $electro_options['footer_bottom_widgets_column_spacing'] ) {
			if( is_rtl() ) {
				$custom_css .= '.footer-bottom-widgets .columns+.columns { margin-right: ' . esc_attr( $electro_options['footer_bottom_widgets_column_spacing'] ) . ';}';
			} else {
		...
		if ( ! $electro_options['footer_bottom_widgets_width_auto'] && ! empty( $electro_options['footer_bottom_widgets_column_width'] ) ) {
			$custom_css .= '.footer-bottom-widgets .columns { width: ' . esc_attr( $electro_options['footer_bottom_widgets_column_width'] ) . '; } .footer-bottom-widgets-menu-inner { justify-content: unset; }';
		}
